        ...
        <div className="max-w-7xl mx-auto px-4 pb-[280px]">
          ...
          <section className="mt-6 mb-8">
            ...
            <div className="space-y-4">
              ...
              {/* Direct Spotify Data Navigation CTA */}
              <button 
                onClick={() => window.location.href = '/spotify-data'}
                className="w-full p-4 rounded-2xl bg-gradient-to-r from-[#1DB954]/20 to-[#1AA34A]/20 border border-[#1DB954]/30 hover:from-[#1DB954]/30 hover:to-[#1AA34A]/30 transition-all"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <div className="w-12 h-12 rounded-full bg-[#1DB954]/20 flex items-center justify-center mr-4">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-7 h-7 text-[#1DB954]">
                        <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.84-.179-.959-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.361 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.179-1.2-.181-1.38-.721-.18-.601.18-1.2.72-1.381 4.26-1.26 11.28-1.02 15.721 1.621.539.3.719 1.02.42 1.56-.299.421-1.02.599-1.559.3z"/>
                      </svg>
                    </div>
                    <div className="text-left">
                      <h4 className="text-white font-semibold text-base">View Your Spotify Data</h4>
                      <p className="text-[#1DB954]/80 text-sm">Explore your complete music analytics & insights</p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <span className="text-[#1DB954] text-sm font-medium mr-2">Open</span>
